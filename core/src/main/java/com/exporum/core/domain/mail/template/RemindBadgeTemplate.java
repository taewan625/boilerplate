...
@Getter
@Setter
public class RemindBadgeTemplate implements MailTemplate {
    ...
    @Builder
    public RemindBadgeTemplate(String orderNumber, String badgeName, String firstName, String lastName, String company,
    ...
    public String getTitle() {
        return STR."[World of Coffee \{this.exhibitionCity}] Badge Information for \{this.firstName + " "+ this.lastName} (Remind)";
    }

    @Override
    public String getTemplatePath() {
        return "mail/BadgeRemind";
    }
